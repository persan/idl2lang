...
with Hello.Time_DataReader;
with Hello.Time_DataWriter;

package body Hello.Time_TypeSupport is
   ...
   begin
      return Hello.Time_DataReader.CreateTypedI;
   ...
   pragma Import (C, Get_Native_Typesupport_Ptr, "Hello_TimeTypeSupport_get_or_delete_instanceI");
   ...
   procedure Register_Type
     (Participant : not null access Standard.DDS.DomainParticipant.Ref'Class;
      ...
      pragma Import (C, InternalCreatePlugin, "Hello_TimePlugin_new");

      procedure InternalDeletePlugin
        (plugin : access PRESTypePlugin);
      pragma Import (C, InternalDeletePlugin, "Hello_TimePlugin_delete");
     ...
     (Participant : not null access Standard.DDS.DomainParticipant.Ref'Class;
      ...
      function Internal
        (Participant : System.Address;
         Type_Name   : in Interfaces.C.Strings.chars_ptr)
         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "Hello_TimeTypeSupport_unregister_type");
   ...
   function Get_Type_Name
     return Standard.DDS.String is
      ...
      pragma Import (C, Internal, "Hello_TimeTypeSupport_get_type_name");
   begin
   ...
   function Create_Data
     (AllocatePointers : in Boolean := True)
      return not null Time_Access
   is
      function Internal (AllocatePointers : in Boolean)
                         return Time_Access;
      pragma Import (C, Internal, "Hello_TimeTypeSupport_create_data_ex");
      Ret : Time_Access;
   begin
      Ret := Internal (AllocatePointers);
      if Ret = null then
         raise Storage_Error with "Unable to create " & "Time";
      else
         return Ret;
      end if;
   end Create_Data;
   ...
   procedure Delete_Data
     (A_Data         : in out Time_Access;
      DeletePointers : in Boolean := True)
   is
      function Internal (A_Data         : in Time_Access;
                         DeletePointers : in Boolean := True)
                         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "Hello_TimeTypeSupport_delete_data_ex");
   begin
      Standard.DDS.Ret_Code_To_Exception
   ...
   procedure Print_Data
     (A_Data : not null access constant Time)
   is
      procedure Internal (A_Data : not null access constant Time);
      pragma Import (C, Internal, "Hello_TimeTypeSupport_print_data");
   begin
      Internal (A_Data);
   end Print_Data;
   ...
   procedure Copy_Data
     (Dest   : not null access Time;
      Source : not null access constant Time)
   is
      function Internal (Dest   : not null access Time;
                         Source : not null access constant Time)
                         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "Hello_TimeTypeSupport_copy_data");
   begin
      Standard.DDS.Ret_Code_To_Exception
   ...
   is
      function Internal (Dest             : not null access Time;
                         AllocatePointers : in Boolean := True)
                         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "Hello_TimeTypeSupport_initialize_data_ex");
   begin
      Standard.DDS.Ret_Code_To_Exception
   ...
   is
      function Internal (Dest           : not null access Time;
                         DeletePointers : in Boolean := True)
                         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "Hello_TimeTypeSupport_finalize_data_ex");
   begin
      Standard.DDS.Ret_Code_To_Exception
   ...
   procedure Finalize is
      ...
      pragma Import (C, Internal, "Hello_TimeTypeSupport_finalize");
   begin
