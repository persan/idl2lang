...
with System;
package Hello.Time_TypeSupport is
   ...
   procedure Delete_Data
     (A_Data : in out Time_Access; DeletePointers : in Boolean := True);

   procedure Print_Data (A_Data : not null access constant Time);
   ...
   package Time_Treats is new
     Standard.DDS.Treats_Generic (Data_Type        => Time,
                                  Data_Type_Access => Time_Access,
