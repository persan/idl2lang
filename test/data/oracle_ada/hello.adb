...
package body Hello is
   ...
   procedure Initialize
     (This              : in out Time) is
      function Internal
        (This : not null access Time)
         return Standard.RTI.Bool;
      pragma Import (C, Internal, "Hello_Time_initialize");
   begin
   ...
   procedure Finalize
     (This            : in out Time) is
      ...
      pragma Import (C, Internal, "Hello_Time_finalize_ex");
   begin
   ...
   procedure Copy
     (Dst : in out Time;
      Src : in Time) is
      function Internal
        (Dst : not null access Time;
         Src : not null access Time)
         return Standard.RTI.Bool;
      pragma Import (C, Internal, "Hello_Time_copy");
   begin
