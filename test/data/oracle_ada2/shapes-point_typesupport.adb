...
with Shapes.Point_DataReader;
with Shapes.Point_DataWriter;

package body Shapes.Point_TypeSupport is
   ...
   begin
      return Shapes.Point_DataReader.CreateTypedI;
   ...
   pragma Import (C, Get_Native_Typesupport_Ptr, "Shapes_PointTypeSupport_get_or_delete_instanceI");
   ...
   procedure Register_Type
     (Participant : not null access Standard.DDS.DomainParticipant.Ref'Class;
      ...
      pragma Import (C, InternalCreatePlugin, "Shapes_PointPlugin_new");

      procedure InternalDeletePlugin
        (plugin : access PRESTypePlugin);
      pragma Import (C, InternalDeletePlugin, "Shapes_PointPlugin_delete");
     ...
     (Participant : not null access Standard.DDS.DomainParticipant.Ref'Class;
      ...
      function Internal
        (Participant : System.Address;
         Type_Name   : in Interfaces.C.Strings.chars_ptr)
         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "Shapes_PointTypeSupport_unregister_type");
   ...
   function Get_Type_Name
     return Standard.DDS.String is
      ...
      pragma Import (C, Internal, "Shapes_PointTypeSupport_get_type_name");
   begin
   ...
   function Create_Data
     (AllocatePointers : in Boolean := True)
      return not null Point_Access
   is
      function Internal (AllocatePointers : in Boolean)
                         return Point_Access;
      pragma Import (C, Internal, "Shapes_PointTypeSupport_create_data_ex");
      Ret : Point_Access;
   begin
      Ret := Internal (AllocatePointers);
      if Ret = null then
         raise Storage_Error with "Unable to create " & "Point";
      else
         return Ret;
      end if;
   end Create_Data;
   ...
   procedure Delete_Data
     (A_Data         : in out Point_Access;
      DeletePointers : in Boolean := True)
   is
      function Internal (A_Data         : in Point_Access;
                         DeletePointers : in Boolean := True)
                         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "Shapes_PointTypeSupport_delete_data_ex");
   begin
      Standard.DDS.Ret_Code_To_Exception
   ...
   procedure Print_Data
     (A_Data : not null access constant Point)
   is
      procedure Internal (A_Data : not null access constant Point);
      pragma Import (C, Internal, "Shapes_PointTypeSupport_print_data");
   begin
      Internal (A_Data);
   end Print_Data;
   ...
   procedure Copy_Data
     (Dest   : not null access Point;
      Source : not null access constant Point)
   is
      function Internal (Dest   : not null access Point;
                         Source : not null access constant Point)
                         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "Shapes_PointTypeSupport_copy_data");
   begin
      Standard.DDS.Ret_Code_To_Exception
   ...
   is
      function Internal (Dest             : not null access Point;
                         AllocatePointers : in Boolean := True)
                         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "Shapes_PointTypeSupport_initialize_data_ex");
   begin
      Standard.DDS.Ret_Code_To_Exception
   ...
   is
      function Internal (Dest           : not null access Point;
                         DeletePointers : in Boolean := True)
                         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "Shapes_PointTypeSupport_finalize_data_ex");
   begin
      Standard.DDS.Ret_Code_To_Exception
   ...
   procedure Finalize is
      ...
      pragma Import (C, Internal, "Shapes_PointTypeSupport_finalize");
   begin
