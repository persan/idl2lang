...
with System;
package Shapes.Polygon_TypeSupport is
   ...
   procedure Delete_Data
     (A_Data : in out Polygon_Access; DeletePointers : in Boolean := True);

   procedure Print_Data (A_Data : not null access constant Polygon);
   ...
   package Polygon_Treats is new
     Standard.DDS.Treats_Generic (Data_Type        => Polygon,
                                  Data_Type_Access => Polygon_Access,
                                  Index_Type       => Standard.DDS.Natural,
                                  First_Element    => 1,
                                  Data_Array       => Polygon_Array,
                                  Initialize       => Initialize,
                                  Finalize         => Finalize,
                                  Copy             => Copy,
                                  Data_Sequences   => Polygon_Seq,
