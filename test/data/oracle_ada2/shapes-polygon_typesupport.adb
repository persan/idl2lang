...
with Shapes.Polygon_DataReader;
with Shapes.Polygon_DataWriter;

package body Shapes.Polygon_TypeSupport is
   ...
   begin
      return Shapes.Polygon_DataReader.CreateTypedI;
   ...
   pragma Import (C, Get_Native_Typesupport_Ptr, "Shapes_PolygonTypeSupport_get_or_delete_instanceI");
   ...
   procedure Register_Type
     (Participant : not null access Standard.DDS.DomainParticipant.Ref'Class;
      ...
      pragma Import (C, InternalCreatePlugin, "Shapes_PolygonPlugin_new");

      procedure InternalDeletePlugin
        (plugin : access PRESTypePlugin);
      pragma Import (C, InternalDeletePlugin, "Shapes_PolygonPlugin_delete");
     ...
     (Participant : not null access Standard.DDS.DomainParticipant.Ref'Class;
      ...
      function Internal
        (Participant : System.Address;
         Type_Name   : in Interfaces.C.Strings.chars_ptr)
         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "Shapes_PolygonTypeSupport_unregister_type");
   ...
   function Get_Type_Name
     return Standard.DDS.String is
      ...
      pragma Import (C, Internal, "Shapes_PolygonTypeSupport_get_type_name");
   begin
   ...
   is
      function Internal (AllocatePointers : in Boolean)
                         return Polygon_Access;
      pragma Import (C, Internal, "Shapes_PolygonTypeSupport_create_data_ex");
      Ret : Polygon_Access;
   begin
      Ret := Internal (AllocatePointers);
      if Ret = null then
         raise Storage_Error with "Unable to create " & "Polygon";
      else
         return Ret;
      end if;
   end Create_Data;
   ...
   procedure Delete_Data
     (A_Data         : in out Polygon_Access;
      DeletePointers : in Boolean := True)
   is
      function Internal (A_Data         : in Polygon_Access;
                         DeletePointers : in Boolean := True)
                         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "Shapes_PolygonTypeSupport_delete_data_ex");
   begin
      Standard.DDS.Ret_Code_To_Exception
   ...
   procedure Print_Data
     (A_Data : not null access constant Polygon)
   is
      procedure Internal (A_Data : not null access constant Polygon);
      pragma Import (C, Internal, "Shapes_PolygonTypeSupport_print_data");
   begin
      Internal (A_Data);
   end Print_Data;
   ...
   procedure Copy_Data
     (Dest   : not null access Polygon;
      Source : not null access constant Polygon)
   is
      function Internal (Dest   : not null access Polygon;
                         Source : not null access constant Polygon)
                         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "Shapes_PolygonTypeSupport_copy_data");
   begin
      Standard.DDS.Ret_Code_To_Exception
   ...
   is
      function Internal (Dest             : not null access Polygon;
                         AllocatePointers : in Boolean := True)
                         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "Shapes_PolygonTypeSupport_initialize_data_ex");
   begin
      Standard.DDS.Ret_Code_To_Exception
   ...
   is
      function Internal (Dest           : not null access Polygon;
                         DeletePointers : in Boolean := True)
                         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "Shapes_PolygonTypeSupport_finalize_data_ex");
   begin
      Standard.DDS.Ret_Code_To_Exception
   ...
   procedure Finalize is
      ...
      pragma Import (C, Internal, "Shapes_PolygonTypeSupport_finalize");
   begin
...
end Shapes.Polygon_TypeSupport;
