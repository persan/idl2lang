...
with System;
package Shapes.Point_TypeSupport is
   ...
   procedure Delete_Data
     (A_Data : in out Point_Access; DeletePointers : in Boolean := True);

   procedure Print_Data (A_Data : not null access constant Point);
   ...
   package Point_Treats is new
     Standard.DDS.Treats_Generic (Data_Type        => Point,
                                  Data_Type_Access => Point_Access,
                                  Index_Type       => Standard.DDS.Natural,
                                  First_Element    => 1,
                                  Data_Array       => Point_Array,
                                  Initialize       => Initialize,
                                  Finalize         => Finalize,
                                  Copy             => Copy,
                                  Data_Sequences   => Point_Seq,
