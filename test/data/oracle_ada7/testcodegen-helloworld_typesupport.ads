...
with System;
package testCodeGen.HelloWorld_TypeSupport is
   ...
   procedure Delete_Data
     (A_Data : in out HelloWorld_Access; DeletePointers : in Boolean := True);

   procedure Print_Data (A_Data : not null access constant HelloWorld);
   ...
   package HelloWorld_Treats is new
     Standard.DDS.Treats_Generic (Data_Type        => HelloWorld,
                                  Data_Type_Access => HelloWorld_Access,
                                  Index_Type       => Standard.DDS.Natural,
                                  First_Element    => 1,
                                  Data_Array       => HelloWorld_Array,
                                  Initialize       => Initialize,
                                  Finalize         => Finalize,
                                  Copy             => Copy,
                                  Data_Sequences   => HelloWorld_Seq,
