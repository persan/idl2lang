...
{
    testCodeGen_HelloWorld *sample = NULL;
    ...
    RTIOsapiHeap_allocateStructure(&(sample),testCodeGen_HelloWorld);
    if (sample == NULL) {
        return NULL;
    }

    if (!testCodeGen_HelloWorld_initialize_w_params(sample,alloc_params)) {
        ...
        testCodeGen_HelloWorld_finalize_w_params(sample, &deallocParams);
        ...
        is freed in the call "testCodeGen_HelloWorld_finalize_ex" */
...
testCodeGen_HelloWorldPluginSupport_create_data_ex(RTIBool allocate_pointers)
{
    ...
    if (!testCodeGen_HelloWorld_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        /* Coverity reports a possible uninit_use_in_call that will happen if the
...
void *
testCodeGen_HelloWorldPluginSupport_create_dataI(void)
{
    return testCodeGen_HelloWorldPluginSupport_create_data_ex(RTI_TRUE);
}

testCodeGen_HelloWorld *
testCodeGen_HelloWorldPluginSupport_create_data(void)
{
    return (testCodeGen_HelloWorld *) testCodeGen_HelloWorldPluginSupport_create_dataI();
}
...
testCodeGen_HelloWorldPluginSupport_destroy_data_w_params(
    ...
    testCodeGen_HelloWorld_finalize_w_params(sample,dealloc_params);
...
testCodeGen_HelloWorldPluginSupport_destroy_data_ex(
    ...
    testCodeGen_HelloWorld_finalize_ex(sample,deallocate_pointers);
...
testCodeGen_HelloWorldPluginSupport_destroy_data(
    ...
    testCodeGen_HelloWorldPluginSupport_destroy_data_ex(sample,RTI_TRUE);

}

void
testCodeGen_HelloWorldPluginSupport_destroy_dataI(
    void *sample)
{
    testCodeGen_HelloWorldPluginSupport_destroy_data((testCodeGen_HelloWorld *) sample);
}
...
{
    return testCodeGen_HelloWorld_copy(dst,(const testCodeGen_HelloWorld*) src);
}
...
testCodeGen_HelloWorldPluginSupport_create_key_ex(RTIBool allocate_pointers){
    testCodeGen_HelloWorld *key = NULL;

    RTIOsapiHeap_allocateStructure(&(key),testCodeGen_HelloWorldKeyHolder);

    testCodeGen_HelloWorld_initialize_ex(key,allocate_pointers, RTI_TRUE);

    return key;
}

void *
testCodeGen_HelloWorldPluginSupport_create_keyI(void)
{
    return testCodeGen_HelloWorldPluginSupport_create_key_ex(RTI_TRUE);
}

testCodeGen_HelloWorld *
testCodeGen_HelloWorldPluginSupport_create_key(void)
{
    return (testCodeGen_HelloWorld *) testCodeGen_HelloWorldPluginSupport_create_keyI();
}
...
{
    testCodeGen_HelloWorld_finalize_ex(key,deallocate_pointers);
...
testCodeGen_HelloWorldPluginSupport_destroy_key(
    ...
    testCodeGen_HelloWorldPluginSupport_destroy_key_ex(key,RTI_TRUE);

}

void
testCodeGen_HelloWorldPluginSupport_destroy_keyI(
    void *key)
{
    testCodeGen_HelloWorldPluginSupport_destroy_key((testCodeGen_HelloWorldKeyHolder *) key);
}
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        ...
        testCodeGen_HelloWorld_get_typecode(),
        &programProperty,
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        participant_data,
        endpoint_info,
        testCodeGen_HelloWorldPluginSupport_create_dataI,
        testCodeGen_HelloWorldPluginSupport_destroy_dataI,
        testCodeGen_HelloWorldPluginSupport_create_keyI ,            testCodeGen_HelloWorldPluginSupport_destroy_keyI);

    if (epd == NULL) {
        return NULL;
    }

    serializedKeyMaxSize =  testCodeGen_HelloWorldPlugin_get_serialized_key_max_size(
        epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
    serializedKeyMaxSizeV2 =  testCodeGen_HelloWorldPlugin_get_serialized_key_max_size_for_keyhash(
        epd,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = testCodeGen_HelloWorldPlugin_get_serialized_sample_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            testCodeGen_HelloWorldPlugin_get_serialized_sample_max_size, epd,
...
testCodeGen_HelloWorldPlugin_return_sample(
    ...
    void *handle)
{
    testCodeGen_HelloWorld_finalize_optional_members(sample, RTI_TRUE);

    PRESTypePluginDefaultEndpointData_returnSample(
        endpoint_data, sample, handle);
}

void testCodeGen_HelloWorldPlugin_finalize_optional_members(
    PRESTypePluginEndpointData endpoint_data,
    testCodeGen_HelloWorld* sample,
    RTIBool deletePointers)
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    testCodeGen_HelloWorld_finalize_optional_members(
...
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    return testCodeGen_HelloWorldPluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    testCodeGen_HelloWorld_get_typecode();
    pd.programs = testCodeGen_HelloWorldPlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
testCodeGen_HelloWorldPlugin_serialize_to_cdr_buffer(
    ...
    const testCodeGen_HelloWorld *sample)
{
    return testCodeGen_HelloWorldPlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!testCodeGen_HelloWorldPlugin_serialize_to_cdr_buffer(
        NULL,
        &length,
        sample)) {
...
RTIBool testCodeGen_HelloWorldPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    testCodeGen_HelloWorld **sample,
    RTIBool * drop_sample,
    struct RTICdrStream *cdrStream,
...
testCodeGen_HelloWorldPlugin_instance_to_key(
    PRESTypePluginEndpointData endpoint_data,
    testCodeGen_HelloWorldKeyHolder *dst, 
    const testCodeGen_HelloWorld *src)
{
    RTIOsapiUtility_unusedParameter(endpoint_data);   
...
testCodeGen_HelloWorldPlugin_key_to_instance(
    PRESTypePluginEndpointData endpoint_data,
    testCodeGen_HelloWorld *dst, const
    testCodeGen_HelloWorldKeyHolder *src)
{
    RTIOsapiUtility_unusedParameter(endpoint_data);   
    if (!RTICdrType_copyDouble (
        &dst->value, 
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *testCodeGen_HelloWorldPlugin_new(void)
{
    ...
    testCodeGen_HelloWorldPlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    testCodeGen_HelloWorldPlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    testCodeGen_HelloWorldPlugin_finalize_optional_members;
    ...
    testCodeGen_HelloWorldPlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    testCodeGen_HelloWorldPlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    testCodeGen_HelloWorldPlugin_get_key_kind;
    ...
    testCodeGen_HelloWorldPlugin_get_key;
    plugin->returnKeyFnc =
    (PRESTypePluginReturnKeyFunction)
    testCodeGen_HelloWorldPlugin_return_key;
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)testCodeGen_HelloWorld_get_typecode();
    #endif
    ...
    testCodeGen_HelloWorldPlugin_get_buffer;
    plugin->returnBuffer =
    (PRESTypePluginReturnBufferFunction)
    testCodeGen_HelloWorldPlugin_return_buffer;
    ...
    plugin->endpointTypeName = testCodeGen_HelloWorldTYPENAME;
...
void
testCodeGen_HelloWorldPlugin_delete(struct PRESTypePlugin *plugin)
{
