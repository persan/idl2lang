...
with System;
package com.saabgroup.enterprisebus.idldemo.MyStruct_TypeSupport is
   ...
   procedure Delete_Data
     (A_Data : in out MyStruct_Access; DeletePointers : in Boolean := True);

   procedure Print_Data (A_Data : not null access constant MyStruct);
   ...
   package MyStruct_Treats is new
     Standard.DDS.Treats_Generic (Data_Type        => MyStruct,
                                  Data_Type_Access => MyStruct_Access,
                                  Index_Type       => Standard.DDS.Natural,
                                  First_Element    => 1,
                                  Data_Array       => MyStruct_Array,
                                  Initialize       => Initialize,
                                  Finalize         => Finalize,
                                  Copy             => Copy,
                                  Data_Sequences   => MyStruct_Seq,
