...
with System;
package a.b.c.foo_TypeSupport is
   ...
   procedure Delete_Data
     (A_Data : in out foo_Access; DeletePointers : in Boolean := True);

   procedure Print_Data (A_Data : not null access constant foo);
   ...
   package foo_Treats is new
     Standard.DDS.Treats_Generic (Data_Type        => foo,
                                  Data_Type_Access => foo_Access,
                                  Index_Type       => Standard.DDS.Natural,
                                  First_Element    => 1,
                                  Data_Array       => foo_Array,
                                  Initialize       => Initialize,
                                  Finalize         => Finalize,
                                  Copy             => Copy,
                                  Data_Sequences   => foo_Seq,
