...
with a.b.c.foo_DataReader;
with a.b.c.foo_DataWriter;

package body a.b.c.foo_TypeSupport is
   ...
   begin
      return a.b.c.foo_DataReader.CreateTypedI;
   ...
   pragma Import (C, Get_Native_Typesupport_Ptr, "a_b_c_fooTypeSupport_get_or_delete_instanceI");
   ...
   procedure Register_Type
     (Participant : not null access Standard.DDS.DomainParticipant.Ref'Class;
      ...
      pragma Import (C, InternalCreatePlugin, "a_b_c_fooPlugin_new");

      procedure InternalDeletePlugin
        (plugin : access PRESTypePlugin);
      pragma Import (C, InternalDeletePlugin, "a_b_c_fooPlugin_delete");
     ...
     (Participant : not null access Standard.DDS.DomainParticipant.Ref'Class;
      ...
      function Internal
        (Participant : System.Address;
         Type_Name   : in Interfaces.C.Strings.chars_ptr)
         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "a_b_c_fooTypeSupport_unregister_type");
   ...
   function Get_Type_Name
     return Standard.DDS.String is
      ...
      pragma Import (C, Internal, "a_b_c_fooTypeSupport_get_type_name");
   begin
   ...
   function Create_Data
     (AllocatePointers : in Boolean := True)
      return not null foo_Access
   is
      function Internal (AllocatePointers : in Boolean)
                         return foo_Access;
      pragma Import (C, Internal, "a_b_c_fooTypeSupport_create_data_ex");
      Ret : foo_Access;
   begin
      Ret := Internal (AllocatePointers);
      if Ret = null then
         raise Storage_Error with "Unable to create " & "foo";
      else
         return Ret;
      end if;
   end Create_Data;
   ...
   procedure Delete_Data
     (A_Data         : in out foo_Access;
      DeletePointers : in Boolean := True)
   is
      function Internal (A_Data         : in foo_Access;
                         DeletePointers : in Boolean := True)
                         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "a_b_c_fooTypeSupport_delete_data_ex");
   begin
      Standard.DDS.Ret_Code_To_Exception
   ...
   procedure Print_Data
     (A_Data : not null access constant foo)
   is
      procedure Internal (A_Data : not null access constant foo);
      pragma Import (C, Internal, "a_b_c_fooTypeSupport_print_data");
   begin
      Internal (A_Data);
   end Print_Data;
   ...
   procedure Copy_Data
     (Dest   : not null access foo;
      Source : not null access constant foo)
   is
      function Internal (Dest   : not null access foo;
                         Source : not null access constant foo)
                         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "a_b_c_fooTypeSupport_copy_data");
   begin
      Standard.DDS.Ret_Code_To_Exception
   ...
   is
      function Internal (Dest             : not null access foo;
                         AllocatePointers : in Boolean := True)
                         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "a_b_c_fooTypeSupport_initialize_data_ex");
   begin
      Standard.DDS.Ret_Code_To_Exception
   ...
   is
      function Internal (Dest           : not null access foo;
                         DeletePointers : in Boolean := True)
                         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "a_b_c_fooTypeSupport_finalize_data_ex");
   begin
      Standard.DDS.Ret_Code_To_Exception
   ...
   procedure Finalize is
      ...
      pragma Import (C, Internal, "a_b_c_fooTypeSupport_finalize");
   begin
