...
with System;
package com.rti.tests.DdsTopics.EngagementControl.ZonedThreatList.Key_TypeSupport is
   ...
   procedure Delete_Data
     (A_Data : in out Key_Access; DeletePointers : in Boolean := True);

   procedure Print_Data (A_Data : not null access constant Key);
   ...
   package Key_Treats is new
     Standard.DDS.Treats_Generic (Data_Type        => Key,
                                  Data_Type_Access => Key_Access,
