...
with hello.World_T_DataReader;
with hello.World_T_DataWriter;

package body hello.World_T_TypeSupport is
   ...
   begin
      return hello.World_T_DataReader.CreateTypedI;
   ...
   pragma Import (C, Get_Native_Typesupport_Ptr, "hello_World_TTypeSupport_get_or_delete_instanceI");
   ...
   procedure Register_Type
     (Participant : not null access Standard.DDS.DomainParticipant.Ref'Class;
      ...
      pragma Import (C, InternalCreatePlugin, "hello_World_TPlugin_new");

      procedure InternalDeletePlugin
        (plugin : access PRESTypePlugin);
      pragma Import (C, InternalDeletePlugin, "hello_World_TPlugin_delete");
     ...
     (Participant : not null access Standard.DDS.DomainParticipant.Ref'Class;
      ...
      function Internal
        (Participant : System.Address;
         Type_Name   : in Interfaces.C.Strings.chars_ptr)
         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "hello_World_TTypeSupport_unregister_type");
   ...
   function Get_Type_Name
     return Standard.DDS.String is
      ...
      pragma Import (C, Internal, "hello_World_TTypeSupport_get_type_name");
   begin
   ...
   function Create_Data
     (AllocatePointers : in Boolean := True)
      return not null World_T_Access
   is
      function Internal (AllocatePointers : in Boolean)
                         return World_T_Access;
      pragma Import (C, Internal, "hello_World_TTypeSupport_create_data_ex");
      Ret : World_T_Access;
   begin
      Ret := Internal (AllocatePointers);
      if Ret = null then
         raise Storage_Error with "Unable to create " & "World_T";
      else
         return Ret;
      end if;
   end Create_Data;
   ...
   procedure Delete_Data
     (A_Data         : in out World_T_Access;
      DeletePointers : in Boolean := True)
   is
      function Internal (A_Data         : in World_T_Access;
                         DeletePointers : in Boolean := True)
                         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "hello_World_TTypeSupport_delete_data_ex");
   begin
      Standard.DDS.Ret_Code_To_Exception
   ...
   procedure Print_Data
     (A_Data : not null access constant World_T)
   is
      procedure Internal (A_Data : not null access constant World_T);
      pragma Import (C, Internal, "hello_World_TTypeSupport_print_data");
   begin
      Internal (A_Data);
   end Print_Data;
   ...
   procedure Copy_Data
     (Dest   : not null access World_T;
      Source : not null access constant World_T)
   is
      function Internal (Dest   : not null access World_T;
                         Source : not null access constant World_T)
                         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "hello_World_TTypeSupport_copy_data");
   begin
      Standard.DDS.Ret_Code_To_Exception
   ...
   is
      function Internal (Dest             : not null access World_T;
                         AllocatePointers : in Boolean := True)
                         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "hello_World_TTypeSupport_initialize_data_ex");
   begin
      Standard.DDS.Ret_Code_To_Exception
   ...
   is
      function Internal (Dest           : not null access World_T;
                         DeletePointers : in Boolean := True)
                         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "hello_World_TTypeSupport_finalize_data_ex");
   begin
      Standard.DDS.Ret_Code_To_Exception
   ...
   procedure Finalize is
      ...
      pragma Import (C, Internal, "hello_World_TTypeSupport_finalize");
   begin
