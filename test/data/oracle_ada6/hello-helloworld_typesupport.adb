...
package body hello.HelloWorld_TypeSupport is
   ...
   begin
      return hello.HelloWorld_DataReader.CreateTypedI;
   ...
   pragma Import (C, Get_Native_Typesupport_Ptr, "hello_HelloWorldTypeSupport_get_or_delete_instanceI");
   ...
   procedure Register_Type
     (Participant : not null access Standard.DDS.DomainParticipant.Ref'Class;
      ...
      pragma Import (C, InternalCreatePlugin, "hello_HelloWorldPlugin_new");

      procedure InternalDeletePlugin
        (plugin : access PRESTypePlugin);
      pragma Import (C, InternalDeletePlugin, "hello_HelloWorldPlugin_delete");
     ...
     (Participant : not null access Standard.DDS.DomainParticipant.Ref'Class;
      ...
      function Internal
        (Participant : System.Address;
         Type_Name   : in Interfaces.C.Strings.chars_ptr)
         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "hello_HelloWorldTypeSupport_unregister_type");
   ...
   function Get_Type_Name
     return Standard.DDS.String is
      ...
      pragma Import (C, Internal, "hello_HelloWorldTypeSupport_get_type_name");
   begin
   ...
   is
      ...
      pragma Import (C, Internal, "hello_HelloWorldTypeSupport_create_data_ex");
   ...
   is
      function Internal (A_Data         : in HelloWorld_Access;
                         DeletePointers : in Boolean := True)
                         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "hello_HelloWorldTypeSupport_delete_data_ex");
   begin
      Standard.DDS.Ret_Code_To_Exception
   ...
   is
      ...
      pragma Import (C, Internal, "hello_HelloWorldTypeSupport_print_data");
   begin
      Internal (A_Data);
   end Print_Data;
   ...
   is
      function Internal (Dest   : not null access HelloWorld;
                         Source : not null access constant HelloWorld)
                         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "hello_HelloWorldTypeSupport_copy_data");
   begin
      Standard.DDS.Ret_Code_To_Exception
   ...
   is
      function Internal (Dest             : not null access HelloWorld;
                         AllocatePointers : in Boolean := True)
                         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "hello_HelloWorldTypeSupport_initialize_data_ex");
   begin
      Standard.DDS.Ret_Code_To_Exception
   ...
   is
      function Internal (Dest           : not null access HelloWorld;
                         DeletePointers : in Boolean := True)
                         return Standard.DDS.ReturnCode_T;
      pragma Import (C, Internal, "hello_HelloWorldTypeSupport_finalize_data_ex");
   begin
      Standard.DDS.Ret_Code_To_Exception
   ...
   procedure Finalize is
      ...
      pragma Import (C, Internal, "hello_HelloWorldTypeSupport_finalize");
   begin
...
end hello.HelloWorld_TypeSupport;
