...
with System;
package hello.World_T_TypeSupport is
   ...
   procedure Delete_Data
     (A_Data : in out World_T_Access; DeletePointers : in Boolean := True);

   procedure Print_Data (A_Data : not null access constant World_T);
   ...
   package World_T_Treats is new
     Standard.DDS.Treats_Generic (Data_Type        => World_T,
                                  Data_Type_Access => World_T_Access,
                                  Index_Type       => Standard.DDS.Natural,
                                  First_Element    => 1,
                                  Data_Array       => World_T_Array,
                                  Initialize       => Initialize,
                                  Finalize         => Finalize,
                                  Copy             => Copy,
                                  Data_Sequences   => World_T_Seq,
