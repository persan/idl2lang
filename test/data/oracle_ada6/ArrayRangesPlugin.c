    ...
    const struct DDS_TypeAllocationParams_t * alloc_params)
{
    ...
    RTIOsapiHeap_allocateStructure(&(sample),hello_World_T);
    if (sample == NULL) {
        return NULL;
    }

    if (!hello_World_T_initialize_w_params(sample,alloc_params)) {
        ...
        hello_World_T_finalize_w_params(sample, &deallocParams);
        ...
        is freed in the call "hello_World_T_finalize_ex" */
...
hello_World_TPluginSupport_create_data_ex(RTIBool allocate_pointers)
{
    ...
    if (!hello_World_T_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        /* Coverity reports a possible uninit_use_in_call that will happen if the
...
void *
hello_World_TPluginSupport_create_dataI(void)
{
    return hello_World_TPluginSupport_create_data_ex(RTI_TRUE);
}

hello_World_T *
hello_World_TPluginSupport_create_data(void)
{
    return (hello_World_T *) hello_World_TPluginSupport_create_dataI();
}
...
hello_World_TPluginSupport_destroy_data_w_params(
    ...
    hello_World_T_finalize_w_params(sample,dealloc_params);
...
hello_World_TPluginSupport_destroy_data_ex(
    ...
    hello_World_T_finalize_ex(sample,deallocate_pointers);
...
hello_World_TPluginSupport_destroy_data(
    ...
    hello_World_TPluginSupport_destroy_data_ex(sample,RTI_TRUE);

}

void
hello_World_TPluginSupport_destroy_dataI(
    void *sample)
{
    hello_World_TPluginSupport_destroy_data((hello_World_T *) sample);
}
...
{
    return hello_World_T_copy(dst,(const hello_World_T*) src);
}
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        participant_data,
        endpoint_info,
        hello_World_TPluginSupport_create_dataI,
        hello_World_TPluginSupport_destroy_dataI,
        NULL , NULL );
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = hello_World_TPlugin_get_serialized_sample_max_size(
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            hello_World_TPlugin_get_serialized_sample_max_size, epd,
...
hello_World_TPlugin_return_sample(
    ...
    void *handle)
{
    hello_World_T_finalize_optional_members(sample, RTI_TRUE);

    PRESTypePluginDefaultEndpointData_returnSample(
        endpoint_data, sample, handle);
}

void hello_World_TPlugin_finalize_optional_members(
    PRESTypePluginEndpointData endpoint_data,
    hello_World_T* sample,
    RTIBool deletePointers)
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    hello_World_T_finalize_optional_members(
...
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    return hello_World_TPluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    hello_World_T_get_typecode();
    pd.programs = hello_World_TPlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
hello_World_TPlugin_serialize_to_cdr_buffer(
    ...
    const hello_World_T *sample)
{
    return hello_World_TPlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!hello_World_TPlugin_serialize_to_cdr_buffer(
        NULL,
        &length,
        sample)) {
...
RTIBool hello_World_TPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    hello_World_T **sample,
    RTIBool * drop_sample,
    struct RTICdrStream *cdrStream,
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *hello_World_TPlugin_new(void)
{
    ...
    hello_World_TPlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    hello_World_TPlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    hello_World_TPlugin_finalize_optional_members;
    ...
    hello_World_TPlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    hello_World_TPlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    hello_World_TPlugin_get_key_kind;
    ...
    */
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)hello_World_T_get_typecode();
    #endif
    ...
    hello_World_TPlugin_get_buffer;
    plugin->returnBuffer =
    (PRESTypePluginReturnBufferFunction)
    hello_World_TPlugin_return_buffer;
    ...
    plugin->endpointTypeName = hello_World_TTYPENAME;
...
void
hello_World_TPlugin_delete(struct PRESTypePlugin *plugin)
{
    RTIOsapiHeap_freeStructure(plugin);
}

/* ----------------------------------------------------------------------------
*  Type hello_HelloWorld
* -------------------------------------------------------------------------- */
    ...
    const struct DDS_TypeAllocationParams_t * alloc_params)
{
    ...
    RTIOsapiHeap_allocateStructure(&(sample),hello_HelloWorld);
    if (sample == NULL) {
        return NULL;
    }

    if (!hello_HelloWorld_initialize_w_params(sample,alloc_params)) {
        struct DDS_TypeDeallocationParams_t deallocParams =
        DDS_TYPE_DEALLOCATION_PARAMS_DEFAULT;
        deallocParams.delete_pointers = alloc_params->allocate_pointers;
        deallocParams.delete_optional_members = alloc_params->allocate_pointers;
        ...
        /* coverity[uninit_use_in_call : FALSE] */
        /* coverity[overwrite_var : FALSE] */
        hello_HelloWorld_finalize_w_params(sample, &deallocParams);
        /* Coverity reports a possible leaked_storage on the sample members when
        freeing sample. It is a false positive since all the members' memory
        is freed in the call "hello_HelloWorld_finalize_ex" */
        /* coverity[leaked_storage : FALSE] */
        RTIOsapiHeap_freeStructure(sample);
        sample=NULL;
    }
...
hello_HelloWorldPluginSupport_create_data_ex(RTIBool allocate_pointers)
{
    ...
    /* coverity[example_checked : FALSE] */
    if (!hello_HelloWorld_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        /* Coverity reports a possible uninit_use_in_call that will happen if the
        new fails. But if new fails then sample == null and the method will
        return before reach this point. */
        /* Coverity reports a possible overwrite_var on the members of the sample.
...
void *
hello_HelloWorldPluginSupport_create_dataI(void)
{
    return hello_HelloWorldPluginSupport_create_data_ex(RTI_TRUE);
}

hello_HelloWorld *
hello_HelloWorldPluginSupport_create_data(void)
{
    return (hello_HelloWorld *) hello_HelloWorldPluginSupport_create_dataI();
}
...
hello_HelloWorldPluginSupport_destroy_data_w_params(
    ...
    const struct DDS_TypeDeallocationParams_t * dealloc_params) {
    hello_HelloWorld_finalize_w_params(sample,dealloc_params);
...
hello_HelloWorldPluginSupport_destroy_data_ex(
    ...
    hello_HelloWorld_finalize_ex(sample,deallocate_pointers);
...
hello_HelloWorldPluginSupport_destroy_data(
    ...
    hello_HelloWorldPluginSupport_destroy_data_ex(sample,RTI_TRUE);

}

void
hello_HelloWorldPluginSupport_destroy_dataI(
    void *sample)
{
    hello_HelloWorldPluginSupport_destroy_data((hello_HelloWorld *) sample);
}
...
{
    return hello_HelloWorld_copy(dst,(const hello_HelloWorld*) src);
}
    ...
    unsigned int indent_level)
{
    ...
    RTICdrType_printArray(
        sample->worlds_1, ((hello_SIZE)), sizeof(hello_World_T),
        (RTICdrTypePrintFunction)hello_World_TPluginSupport_print_data,
        "worlds_1",
        RTIOsapiUtility_uInt32Plus1(indent_level));

    RTICdrType_printArray(
        sample->worlds_2, (24L), sizeof(hello_World_T),
        (RTICdrTypePrintFunction)hello_World_TPluginSupport_print_data,
        "worlds_2",
        RTIOsapiUtility_uInt32Plus1(indent_level));

    RTICdrType_printArray(
        sample->profile_1, (24L), RTI_CDR_BOOLEAN_SIZE,
        (RTICdrTypePrintFunction)RTICdrType_printBoolean,
        "profile_1",
        RTIOsapiUtility_uInt32Plus1(indent_level));

    RTICdrType_printArray(
        sample->profile_2, ((hello_SIZE)), RTI_CDR_BOOLEAN_SIZE,
        (RTICdrTypePrintFunction)RTICdrType_printBoolean,
        "profile_2",
        RTIOsapiUtility_uInt32Plus1(indent_level));
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        participant_data,
        endpoint_info,
        hello_HelloWorldPluginSupport_create_dataI,
        hello_HelloWorldPluginSupport_destroy_dataI,
        NULL , NULL );
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = hello_HelloWorldPlugin_get_serialized_sample_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        PRESTypePluginDefaultEndpointData_setMaxSizeSerializedSample(epd, serializedSampleMaxSize);
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            endpoint_info,
            (PRESTypePluginGetSerializedSampleMaxSizeFunction)
            hello_HelloWorldPlugin_get_serialized_sample_max_size, epd,
            (PRESTypePluginGetSerializedSampleSizeFunction)
            PRESTypePlugin_interpretedGetSerializedSampleSize,
            epd) == RTI_FALSE) {
            PRESTypePluginDefaultEndpointData_delete(epd);
...
hello_HelloWorldPlugin_return_sample(
    ...
    void *handle)
{
    hello_HelloWorld_finalize_optional_members(sample, RTI_TRUE);

    PRESTypePluginDefaultEndpointData_returnSample(
        endpoint_data, sample, handle);
}

void hello_HelloWorldPlugin_finalize_optional_members(
    PRESTypePluginEndpointData endpoint_data,
    hello_HelloWorld* sample,
    RTIBool deletePointers)
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    hello_HelloWorld_finalize_optional_members(
        sample, deletePointers);
}
...
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    return hello_HelloWorldPluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    plugin.typeCode = (struct RTICdrTypeCode *)
    hello_HelloWorld_get_typecode();
    pd.programs = hello_HelloWorldPlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
hello_HelloWorldPlugin_serialize_to_cdr_buffer(
    ...
    const hello_HelloWorld *sample)
{
    return hello_HelloWorldPlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
        DDS_AUTO_DATA_REPRESENTATION);
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!hello_HelloWorldPlugin_serialize_to_cdr_buffer(
        NULL,
        &length,
        sample)) {
        return DDS_RETCODE_ERROR;
...
RTIBool hello_HelloWorldPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    hello_HelloWorld **sample,
    RTIBool * drop_sample,
    struct RTICdrStream *cdrStream,
...
* Plug-in Installation Methods
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *hello_HelloWorldPlugin_new(void)
{
    struct PRESTypePlugin *plugin = NULL;
    const struct PRESTypePluginVersion PLUGIN_VERSION =
    PRES_TYPE_PLUGIN_VERSION_2_0;
    ...
    plugin->createSampleFnc =
    (PRESTypePluginCreateSampleFunction)
    hello_HelloWorldPlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    hello_HelloWorldPlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    hello_HelloWorldPlugin_finalize_optional_members;
    ...
    plugin->getSampleFnc =
    (PRESTypePluginGetSampleFunction)
    hello_HelloWorldPlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    hello_HelloWorldPlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    hello_HelloWorldPlugin_get_key_kind;
    ...
    */
    ...
    plugin->typeCode = NULL;
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)hello_HelloWorld_get_typecode();
    #endif
    plugin->languageKind = PRES_TYPEPLUGIN_DDS_TYPE;
    ...
    plugin->getBuffer =
    (PRESTypePluginGetBufferFunction)
    hello_HelloWorldPlugin_get_buffer;
    plugin->returnBuffer =
    (PRESTypePluginReturnBufferFunction)
    hello_HelloWorldPlugin_return_buffer;
    plugin->getBufferWithParams = NULL;
    plugin->returnBufferWithParams = NULL;
    plugin->getSerializedSampleSizeFnc =
    (PRESTypePluginGetSerializedSampleSizeFunction)
    ...
    plugin->endpointTypeName = hello_HelloWorldTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    plugin->isRecursiveType = RTI_FALSE;
    return plugin;
}
...
void
hello_HelloWorldPlugin_delete(struct PRESTypePlugin *plugin)
{
    RTIOsapiHeap_freeStructure(plugin);
}
